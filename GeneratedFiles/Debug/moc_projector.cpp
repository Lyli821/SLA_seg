...
static const char qt_meta_stringdata_Projector[] = {
    "Projector\0"
};
...
const QMetaObjectExtraData Projector::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Projector::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Projector,
      qt_meta_data_Projector, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Projector::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Projector))
